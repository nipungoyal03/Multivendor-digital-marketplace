...
def index(request):
    ...
    return render(request, "marketapp/index.html", {"products": products})
...
def payment_success_view(request):
    ...
    return render(request, "marketapp/payment_success.html", {"order": order})


def payment_failed_view(request):
    return render(request, "marketapp/failed.html")
...
def create_product(request):
    ...
    return render(
        request, "marketapp/create_product.html", {"product_form": product_form}
    )
...
def product_delete(request, id):
    ...
    if request.method == "POST":
        product.delete()
        return redirect("index")
    return render(request, "marketapp/delete.html", {"product": product})


def dashboard(request):
    products = Product.objects.filter(seller=request.user)
    return render(request, "marketapp/dashboard.html", {"products": products})
...
def register(request):
    ...
    return render(request, "marketapp/register.html", {"user_form": user_form})


def invalid(request):
    return render(request, "marketapp/invalid.html")


def my_purchases(request):
    orders = OrderDetail.objects.filter(customer_email=request.user.email)
    return render(request, "marketapp/purchases.html", {"orders": orders})
